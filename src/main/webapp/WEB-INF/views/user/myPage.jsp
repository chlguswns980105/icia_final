...
<header>
   ...
   <ul class="mpList_tab">
            ...
            <li>
               <a class="tab_link changeList" id="changeTab">교환 신청한 목록</a>
            </li>
            <li>
               <a class="tab_link changeRList" id="changeRTab">교환 요청 받은 목록</a>
            </li>
       </ul>
   <div id="buyList">
   <div>
   ...
   <script id = "myPageTemp" type = "text/x-handlebars-template">
		...
		{{#each myList}}
            ...
            <td>{{seat_num}}번</td>
            <td>{{reser_go}}</td>
            <td class = "price">{{numberFormat reser_price}}</td>
            <td>{{reser_date}}</td>
   ...
   <script>
   	...
   	Handlebars.registerHelper("numberFormat", function(price) {
